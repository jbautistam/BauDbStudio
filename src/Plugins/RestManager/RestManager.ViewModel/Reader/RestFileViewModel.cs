...
namespace Bau.Libraries.RestManager.ViewModel.Reader;

/// <summary>
///		ViewModel para ver el contenido de un archivo multimedia
/// </summary>
public class RestFileViewModel : BauMvvm.ViewModels.Forms.Dialogs.BaseDialogViewModel
{
	// Eventos públícos
	...
	public RestFileViewModel(RestManagerViewModel mediaFileListView, string fileName, bool isAudio)
	{ 
		// Asigna los objetos

...
using Bau.Libraries.RestManager.ViewModel.Reader;
...
public partial class MediaFileView : Window
{
	...
	public MediaFileView(RestFileViewModel viewModel)
	{
		...
		ViewModel.PropertyChanged += (sender, args) => {
															if (!string.IsNullOrWhiteSpace(args.PropertyName) &&
																	args.PropertyName.Equals(nameof(RestFileViewModel.OverAllWindows), 

	...
	public partial class NoteView : Window
	{
		...
		public NoteView(NoteViewModel viewModel)
		{
			...
			ViewModel.PropertyChanged += (sender, args) => {
																if (args.PropertyName.Equals(nameof(NoteViewModel.OverAllWindows), StringComparison.CurrentCultureIgnoreCase))
		...
		{
			ViewModel.Background = new BauMvvm.ViewModels.Media.MvvmColor("FFE97F");
		}

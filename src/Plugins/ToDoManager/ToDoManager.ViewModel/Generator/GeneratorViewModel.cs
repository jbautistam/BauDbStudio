...
namespace Bau.Libraries.ToDoManager.ViewModel.Generator
{
	/// <summary>
	...
	public class GeneratorViewModel : BauMvvm.ViewModels.Forms.Dialogs.BaseDialogViewModel
	{
		...
		private string _password, _except, _include;
		private int  _minLength, _maxLength;
		private bool _withUpperCase, _withLowerCase, _withDigit, _withSpecial;

		public GeneratorViewModel(Reader.GroupViewModel entryViewModel)
		{
			System.Random random = new Random(3);
		...
		/// </summary>
		public Reader.GroupViewModel EntryViewModel { get; }

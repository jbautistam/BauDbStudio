...
namespace Bau.Libraries.PasswordManager.ViewModel.Reader
{
	...
	{
		// Variables privadas
		private string _fileName, _password;
		...
		public void SaveDetails(bool newName)
		{
			...
			{
				string newFileName = MainViewModel.ViewsController.DialogsController.OpenDialogSave(string.Empty, "Archivo cifrado (*.bau.enc)|*.bau.enc|Todos los archivos (*.*)|*.*",
																									FileName, ".bau.enc");
		...
		/// </summary>
		internal bool CanUpdateSelectedEntry()
		{
			return SelectedEntry is null || SelectedEntry.UpdateEntry();
		}

...
SELECT CalendarIso.[Date], 
 ...
 [StockIntervalsCte].[ProductId] = [ProductsCte].[ProductId]
						...
						INNER JOIN Fact.ProductCostAndPriceByPointOfSaleIntervals
						 ...
						 GROUP BY [PointsOfSaleCte].[City], [PointsOfSaleCte].[ErpCode], [PointsOfSaleCte].[PointOfSale], [PointsOfSaleCte].[ImageUrl], [PointsOfSaleCte].[ChannelName], [PointsOfSaleCte].[PointOfSaleClassificationLevel1], [PointsOfSaleCte].[PointOfSaleClassificationLevel2], [ProductsCte].[ProductDescription], [ProductsCte].[EanCode], [ProductsCte].[ProductCode], [ProductsCte].[UrlImage], [ProductsCte].[ClassificationLevelValue1], [ProductsCte].[ClassificationLevelValue3], [ProductsCte].[ClassificationLevelValue5], [ProductsCte].[Typology], CalendarIso.[Date]
),
StockDvCte AS 
(
SELECT CalendarIso.Date,
								[ProductsCte].[ProductDescription], [ProductsCte].[EanCode], [ProductsCte].[ProductCode], [ProductsCte].[UrlImage], [ProductsCte].[ClassificationLevelValue1], [ProductsCte].[ClassificationLevelValue3], [ProductsCte].[ClassificationLevelValue5], [ProductsCte].[Typology], [PointsOfSaleCte].[City], [PointsOfSaleCte].[ErpCode], [PointsOfSaleCte].[PointOfSale], [PointsOfSaleCte].[ImageUrl], [PointsOfSaleCte].[ChannelName], [PointsOfSaleCte].[PointOfSaleClassificationLevel1], [PointsOfSaleCte].[PointOfSaleClassificationLevel2], 
 ...
 [StockIntervalsCte].[ProductId] = [ProductsCte].[ProductId]
						 INNER JOIN  PointsOfSaleCte
															ON 
 [StockIntervalsCte].[PointOfSaleId] = [PointsOfSaleCte].[PointOfSaleId]
						 GROUP BY [ProductsCte].[ProductDescription], [ProductsCte].[EanCode], [ProductsCte].[ProductCode], [ProductsCte].[UrlImage], [ProductsCte].[ClassificationLevelValue1], [ProductsCte].[ClassificationLevelValue3], [ProductsCte].[ClassificationLevelValue5], [ProductsCte].[Typology], [PointsOfSaleCte].[City], [PointsOfSaleCte].[ErpCode], [PointsOfSaleCte].[PointOfSale], [PointsOfSaleCte].[ImageUrl], [PointsOfSaleCte].[ChannelName], [PointsOfSaleCte].[PointOfSaleClassificationLevel1], [PointsOfSaleCte].[PointOfSaleClassificationLevel2], CalendarIso.Date
),
...
(
SELECT [City], [ErpCode], [PointOfSale], [ImageUrl], [ChannelName], [PointOfSaleClassificationLevel1], [PointOfSaleClassificationLevel2], [ProductDescription], [EanCode], [ProductCode], [UrlImage], [ClassificationLevelValue1], [ClassificationLevelValue3], [ClassificationLevelValue5], [Typology], 
								   Date, COUNT(1) AS DesignVariationsWithSales
								FROM AnalysisFilteredCte
								 GROUP BY [City], [ErpCode], [PointOfSale], [ImageUrl], [ChannelName], [PointOfSaleClassificationLevel1], [PointOfSaleClassificationLevel2], [ProductDescription], [EanCode], [ProductCode], [UrlImage], [ClassificationLevelValue1], [ClassificationLevelValue3], [ClassificationLevelValue5], [Typology], AnalysisRootProductCode, Date
								HAVING SUM(Sales) > 0
),
AnalysisCte AS 
(
SELECT AnalysisFilteredCte.Date,
						   [AnalysisFilteredCte].[City], [AnalysisFilteredCte].[ErpCode], [AnalysisFilteredCte].[PointOfSale], [AnalysisFilteredCte].[ImageUrl], [AnalysisFilteredCte].[ChannelName], [AnalysisFilteredCte].[PointOfSaleClassificationLevel1], [AnalysisFilteredCte].[PointOfSaleClassificationLevel2], [AnalysisFilteredCte].[ProductDescription], [AnalysisFilteredCte].[EanCode], [AnalysisFilteredCte].[ProductCode], [AnalysisFilteredCte].[UrlImage], [AnalysisFilteredCte].[ClassificationLevelValue1], [AnalysisFilteredCte].[ClassificationLevelValue3], [AnalysisFilteredCte].[ClassificationLevelValue5], [AnalysisFilteredCte].[Typology], 
 ...
 AND  IsNull([AnalysisFilteredCte].[Typology], '') = IsNull([AnalysisDvSalesCte].[Typology], '') AND 
...
SELECT IsNull([StockCte].[City], [AnalysisCte].[City]) AS City, IsNull([StockCte].[ErpCode], [AnalysisCte].[ErpCode]) AS ErpCode, IsNull([StockCte].[PointOfSale], [AnalysisCte].[PointOfSale]) AS PointOfSale, IsNull([StockCte].[ImageUrl], [AnalysisCte].[ImageUrl]) AS ImageUrl, IsNull([StockCte].[ChannelName], [AnalysisCte].[ChannelName]) AS ChannelName, IsNull([StockCte].[PointOfSaleClassificationLevel1], [AnalysisCte].[PointOfSaleClassificationLevel1]) AS PointOfSaleClassificationLevel1, IsNull([StockCte].[PointOfSaleClassificationLevel2], [AnalysisCte].[PointOfSaleClassificationLevel2]) AS PointOfSaleClassificationLevel2, IsNull([StockCte].[ProductDescription], [AnalysisCte].[ProductDescription]) AS ProductDescription, IsNull([StockCte].[EanCode], [AnalysisCte].[EanCode]) AS EanCode, IsNull([StockCte].[ProductCode], [AnalysisCte].[ProductCode]) AS ProductCode, IsNull([StockCte].[UrlImage], [AnalysisCte].[UrlImage]) AS UrlImage, IsNull([StockCte].[ClassificationLevelValue1], [AnalysisCte].[ClassificationLevelValue1]) AS ClassificationLevelValue1, IsNull([StockCte].[ClassificationLevelValue3], [AnalysisCte].[ClassificationLevelValue3]) AS ClassificationLevelValue3, IsNull([StockCte].[ClassificationLevelValue5], [AnalysisCte].[ClassificationLevelValue5]) AS ClassificationLevelValue5, IsNull([StockCte].[Typology], [AnalysisCte].[Typology]) AS Typology, 
 ...
 AND  IsNull([StockCte].[Typology], '') = IsNull([StockDvCte].[Typology], '') AND 
 ...
 AND  IsNull([StockCte].[Typology], '') = IsNull([AnalysisCte].[Typology], '') AND 
...
SELECT [ReportCte].[City], [ReportCte].[ErpCode], [ReportCte].[PointOfSale], [ReportCte].[ImageUrl], [ReportCte].[ChannelName], [ReportCte].[PointOfSaleClassificationLevel1], [ReportCte].[PointOfSaleClassificationLevel2], [ReportCte].[ProductDescription], [ReportCte].[EanCode], [ReportCte].[ProductCode], [ReportCte].[UrlImage], [ReportCte].[ClassificationLevelValue1], [ReportCte].[ClassificationLevelValue3], [ReportCte].[ClassificationLevelValue5], [ReportCte].[Typology], 
							ReportCte.Date,

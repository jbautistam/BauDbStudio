...
namespace Bau.Libraries.LibReporting.Requests.Models
{
	...
	public class ReportRequestModel
	{
		...
		/// </summary>
		public bool IsRequestedDimension(string dimensionKey)
		{
			return IsRequestedDimension(new List<string> { dimensionKey });
		}
		...
		/// </summary>
		public bool IsRequestedExpression(string expressionKey)
		{
			return IsRequestedExpression(new List<string> { expressionKey });
		}

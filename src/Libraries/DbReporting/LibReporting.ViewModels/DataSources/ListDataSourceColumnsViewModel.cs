...
namespace Bau.Libraries.LibReporting.ViewModels.DataSources
{
	...
	{
		// Variables privadas
		private ObservableCollection<ListItemDataSourceColumnViewModel> _items;
		...
		private void DeleteColumn()
		{
			if (Updatable && SelectedItem != null && 
					ReportingSolutionViewModel.SolutionViewModel.MainViewModel.MainController.HostController.SystemController.ShowQuestion("¿Realmente desea borrar esta columna?"))

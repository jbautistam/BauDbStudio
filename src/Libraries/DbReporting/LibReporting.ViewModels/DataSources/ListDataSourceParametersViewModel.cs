...
namespace Bau.Libraries.LibReporting.ViewModels.DataSources
{
	/// <summary>
	...
	{
		// Variables privadas
		private ObservableCollection<ListItemDataSourceParameterViewModel> _items;
		...
		{
			List<DataSourceSqlParameterModel> parameters = new List<DataSourceSqlParameterModel>();
		...
		private void DeleteParameter()
		{
			if (Updatable && SelectedItem != null && 
					ReportingSolutionViewModel.SolutionViewModel.MainViewModel.MainController.HostController.SystemController.ShowQuestion("¿Realmente desea borrar este parámetro?"))

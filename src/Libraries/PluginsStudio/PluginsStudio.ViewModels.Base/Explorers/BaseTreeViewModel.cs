...
{
	// Variables privadas
	private ObservableCollection<ControlHierarchicalViewModel> _children;
	private BaseTreeNodeViewModel _selectedNode;

	protected BaseTreeViewModel()
	{
		// Asigna las propiedades
		Children = new ObservableCollection<ControlHierarchicalViewModel>();
	...
	/// </summary>
	private List<ControlHierarchicalViewModel> GetNodesExpanded(ObservableCollection<ControlHierarchicalViewModel> nodes)
	{
	...
	///		Expande todos los nodos
	/// </summary>
	private void ExpandAll(ObservableCollection<ControlHierarchicalViewModel> nodes)
	{
		foreach (ControlHierarchicalViewModel node in nodes)
		{
			// Expande el nodo
	...
	/// </summary>
	private void ExpandNodes(ObservableCollection<ControlHierarchicalViewModel> nodes, List<ControlHierarchicalViewModel> nodesExpanded)
	{ 
		if (nodes != null)
			foreach (ControlHierarchicalViewModel node in nodes)
	...
	{ 
		...
		foreach (ControlHierarchicalViewModel nodeExpanded in nodesExpanded)
			if (nodeExpanded is BaseTreeNodeViewModel nodeFirst && node is BaseTreeNodeViewModel nodeSecond)
			{
	...
	///		Nodos
	/// </summary>
	public ObservableCollection<ControlHierarchicalViewModel> Children 
	{ 

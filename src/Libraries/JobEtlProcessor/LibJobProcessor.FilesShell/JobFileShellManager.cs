...
namespace Bau.Libraries.LibJobProcessor.FilesShell
{
	...
	/// </summary>
	public class JobFileShellManager : Core.Interfaces.IJobProcesor
	{
		public JobFileShellManager(LibLogger.Core.LogManager logger)
		{
			Logger = logger;
		}
		...
		///		Clave del proveedor
		/// </summary>
		public string Key { get; } = "ShellManager";

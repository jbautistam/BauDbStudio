...
namespace Bau.Libraries.LibDbScripts.Manager
{
	/// <summary>
	...
	{
		public DbScriptManager(DbAggregatorManager dataProviderManager, NormalizedDictionary<object> parameters, NormalizedDictionary<string> paths, LogManager logger)
		{
		...
		/// </summary>
		public async Task<bool> ProcessByFileAsync(string fileName, CancellationToken cancellationToken)
		{
		...
		/// </summary>
		public async Task<bool> ProcessBySqlScriptAsync(string target, string fileName, CancellationToken cancellationToken)
		{
		...
		/// </summary>
		public async Task<bool> ProcessByXmlAsync(string xml, string pathBase, CancellationToken cancellationToken)
		{

...
namespace Bau.Libraries.DbStudio.ViewModels.Core.Tools
{
	/// <summary>
	...
	public class CreateFileViewModel : BauMvvm.ViewModels.Forms.Dialogs.BaseDialogViewModel
	{
		...
		public CreateFileViewModel(MainViewModel mainViewModel, string path)
		{
		...
		private bool ValidateData()
		{
			bool validated = false;
				...
				if (string.IsNullOrWhiteSpace(FileName))
					MainViewModel.MainController.HostController.SystemController.ShowMessage("Introduzca el nombre de archivo");
				else if (System.IO.File.Exists(FullFileName))
					MainViewModel.MainController.HostController.SystemController.ShowMessage("Ya existe este nombre de archivo en el directorio");
				else
					validated = true;

		...
		internal bool ValidataData()
		{
			bool validated = false;
				...
				if (GetSelectedType() == BaseFileViewModel.FieldType.Unknown)
					ListViewModel.FileViewModel.SolutionViewModel.MainViewModel.MainController.HostController.SystemController.ShowMessage("Seleccione el tipo de la columna");
				else
					validated = true;

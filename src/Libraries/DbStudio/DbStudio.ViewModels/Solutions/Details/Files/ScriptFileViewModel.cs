...
namespace Bau.Libraries.DbStudio.ViewModels.Solutions.Details.Files
{
	...
	{
		public ScriptFileViewModel(SolutionViewModel solutionViewModel, string fileName) : base(solutionViewModel.MainViewModel.MainController.PluginController, fileName)
		{

...
namespace Bau.Libraries.DbStudio.ViewModels.Solutions.Details.Reporting.DataWarehouses
{
	/// <summary>
		...
		private bool ValidateData()
		{
			bool validated = false;
				...
				if (string.IsNullOrWhiteSpace(Name))
					ReportingSolutionViewModel.SolutionViewModel.MainViewModel.MainController.HostController.SystemController.ShowMessage("Introduzca el nombre del almacén de datos");
				else 
					validated = true;

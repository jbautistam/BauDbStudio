	...
	public class ReportViewModel : BaseObservableObject, IDetailViewModel
	{
		...
		private void DeleteDataSource()
		{
			if (SelectedDataSource != null && 
					ReportingSolutionViewModel.SolutionViewModel.MainViewModel.MainController.HostController.SystemController.ShowQuestion("¿Desea quitar este origen de datos del informe?"))
		...
		private bool ValidateDataSources()
		{
			bool validated = false;
				...
				if (DataSources.Count == 0)
					ReportingSolutionViewModel.SolutionViewModel.MainViewModel.MainController.HostController.SystemController.ShowMessage("Seleccione un origen de datos");
				else
				{

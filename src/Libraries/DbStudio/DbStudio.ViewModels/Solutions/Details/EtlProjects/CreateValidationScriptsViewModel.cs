			...
			bool validated = false;
				...
				else if (ValidateFiles)
				{
					if (string.IsNullOrWhiteSpace(MountPathVariable))
						...
						SolutionViewModel.MainViewModel.MainController.HostController.SystemController.ShowMessage("Introduzca el directorio de archivos");
					else if (string.IsNullOrWhiteSpace(PathValidate))
						SolutionViewModel.MainViewModel.MainController.HostController.SystemController.ShowMessage("Introduzca el nombre del subdirectorio donde se encuentran los archivos a validar");
					else 
						validated = true;
				}
				else
				{
					if (string.IsNullOrWhiteSpace(DataBaseTarget))
						SolutionViewModel.MainViewModel.MainController.HostController.SystemController.ShowMessage("Introduzca el nombre de base de datos a comparar");
					else
						validated = true;
				}

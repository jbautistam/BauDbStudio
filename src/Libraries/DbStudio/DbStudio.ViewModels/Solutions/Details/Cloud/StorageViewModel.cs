...
namespace Bau.Libraries.DbStudio.ViewModels.Solutions.Details.Cloud
{
	/// <summary>
	...
	public class StorageViewModel : BauMvvm.ViewModels.Forms.Dialogs.BaseDialogViewModel
	{
		...
		private bool ValidateData()
		{
			bool validated = false;
				...
				// Comprueba los datos introducidos
				if (string.IsNullOrWhiteSpace(Name))
					SolutionViewModel.MainViewModel.MainController.HostController.SystemController.ShowMessage("Introduzca el nombre del storage");
				else if (string.IsNullOrWhiteSpace(ConnectionString))
					SolutionViewModel.MainViewModel.MainController.HostController.SystemController.ShowMessage("Seleccione la cadena de conexión");
				else
					validated = true;

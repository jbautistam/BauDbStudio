...
namespace Bau.Libraries.DbStudio.ViewModels.Details.Reporting.Queries
{
	...
	{
		// Variables privadas
		private ComboViewModel _comboConditions;
		...
		/// </summary>
		internal FilterRequestModel.ConditionType GetSelectedCondition()
		{
			return (FilterRequestModel.ConditionType) (ComboConditions.SelectedId ?? 0);
		}

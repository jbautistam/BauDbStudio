...
public class ChartViewModel : BaseObservableObject
{
	...
	private ComboViewModel _comboChartTypes = default!, _comboOrientationTypes = default!, _comboLegend = default!;
	private ComboViewModel _comboFieldSeries = default!;
	private ChartSeriesViewModel _seriesViewModel = default!;
	...
	private List<string> GetLabels(string? field)
	{
		List<string> labels = new();
			...
			if (!string.IsNullOrWhiteSpace(field))
			{
				...
				if (QueryViewModel.DataResults is not null)

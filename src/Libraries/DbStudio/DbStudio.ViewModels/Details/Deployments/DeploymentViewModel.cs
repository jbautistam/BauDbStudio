...
namespace Bau.Libraries.DbStudio.ViewModels.Details.Deployments
{
	/// <summary>
	...
	public class DeploymentViewModel : BauMvvm.ViewModels.Forms.Dialogs.BaseDialogViewModel
	{
		...
		private bool ValidateData()
		{
			bool validated = false;
				...
				// Comprueba los datos introducidos
				if (string.IsNullOrWhiteSpace(Name))
					SolutionViewModel.MainController.SystemController.ShowMessage("Introduzca el nombre de la distribución");
					...
					SolutionViewModel.MainController.SystemController.ShowMessage("Seleccione el directorio origen");
				else if (!System.IO.Directory.Exists(SourcePath))
					SolutionViewModel.MainController.SystemController.ShowMessage("El directorio origen no existe");
				else if (string.IsNullOrWhiteSpace(TargetPath))
					SolutionViewModel.MainController.SystemController.ShowMessage("Seleccione el directorio destino");
				else
					validated = true;

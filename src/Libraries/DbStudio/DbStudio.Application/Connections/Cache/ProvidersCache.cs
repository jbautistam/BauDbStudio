...
namespace Bau.Libraries.DbStudio.Application.Connections.Cache
{
	/// <summary>
	...
	internal class ProvidersCache
	{
		...
		/// </summary>
		internal NormalizedDictionary<ProviderCacheItem> Providers { get; } = new NormalizedDictionary<ProviderCacheItem>();
	}
}

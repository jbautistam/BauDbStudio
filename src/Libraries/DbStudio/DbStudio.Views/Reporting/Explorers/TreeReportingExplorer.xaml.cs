...
namespace Bau.Libraries.DbStudio.Views.Reporting.Explorers;

/// <summary>
///		Arbol del explorador de informes
/// </summary>
public partial class TreeReportingExplorer : UserControl
{
	// Variables privadas
	...
	/// </summary>
	public TreeReportingViewModel ViewModel { get; }

	private void trvExplorer_SelectedItemChanged(object sender, RoutedPropertyChangedEventArgs<object> e)
	{ 
		if (trvExplorer.DataContext is TreeReportingViewModel && (sender as TreeView)?.SelectedItem is PluginNodeViewModel node)
